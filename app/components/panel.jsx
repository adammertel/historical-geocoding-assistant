  ...
  render () {
    ...
    return (
      <div className='panel-wrapper' style={this.style()}>
            ...
            <table className='table centered'>
              <tbody>
                <tr key='0'>
                  ...
                  <td>
                    <Input
                      onChange={this.handleChangeInput.bind(this, store.opts.columns.x)}
                      type='number'
                      value={store.recordX}
                    />
                  </td>
                ...
                <tr key='1'>
                  ...
                  <td>
                    <Input
                      onChange={this.handleChangeInput.bind(this, store.opts.columns.y)}
                      type='number'
                      value={store.recordY}
                    />
                  </td>
              ...
              <tbody>
                {Object.keys(store.recordData)
                  ...
                  .map((column, ci) => {
                    ...
                    const shortenColumn = column.length > 13
                      ? column.substr(0, 12) + '...'
                      : column
        ...
        <Menu label='settings' defaultOpen icon='wrench' iconColor={config.colors.main}>
          <div>
            ...
            <div className='checkboxes-line'>
              ...
              <div style={{}} className='field'>
                <div style={{ display: 'inline-block', fontSize: 9 }} className='select'>
                  <select
